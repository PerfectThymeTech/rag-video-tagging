...
# bp_newstagextraction = df.Blueprint()


# @bp_newstagextraction.route(route="startNewsTagExtraction")
# @bp_newstagextraction.durable_client_input(client_name="client")
...
#         payload_obj: NewsTagExtractionOrchestratorRequest = NewsTagExtractionOrchestratorRequest.model_validate(payload)

#         # Start orchestrator
#         instance_id = await client.start_new(
#             "news_tag_extraction_orchestrator", client_input=payload
#         )
...
# @bp_newstagextraction.orchestration_trigger(
#     context_name="context"
# )  # , orchestration="NewsTagOrchestrator")
# def news_tag_extraction_orchestrator(context: df.DurableOrchestrationContext):
#     # Define retry logic
...
#     )
#     result = {"error_code": 0, "text": result_extract_transcript.transcript_text}
#     return result


# @bp_newstagextraction.activity_trigger(input_name="inputData")  # , activity="ExtractTranscript")
